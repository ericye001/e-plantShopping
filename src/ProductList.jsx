                ...
                <div key={index}>
                    ...
                    <div className="product-list">
                        ...
                        <div className="product-card" key={plantIndex}>
                            ...
                            <button style={{backgroundColor:alreadyInCart(plant.name)?"gray":"#e74c3c"}} disabled={alreadyInCart(plant.name)? true:false} className="product-button" onClick={() => handleAddToCart({name:plant.name,cost:plant.cost,image:plant.image})}>Add to Cart</button>
                        </div>
                        ))}
                    </div>
                </div>
